...
public class RedisEhcacheCache extends AbstractValueAdaptingCache {
    ...
    public RedisEhcacheCache(String name, RedisTemplate<Object, Object> redisTemplate, Cache ehcacheCache, RedisEhcacheProperties redisEhcacheProperties) {
    ...
    public void put(Object key, Object value) {
        ...
        setAndPushRedis(key, value);

        ehcacheCache.put(new Element(key, value));
    }

    private void setAndPushRedis(Object key, Object value) {
    ...
    public ValueWrapper putIfAbsent(Object key, Object value) {
        ...
        synchronized (key) {
            ...
            if (prevValue == null) {
                ...
                ehcacheCache.put(new Element(key, toStoreValue(value)));
            }
        }
    ...
    protected Object lookup(Object key) {
        Object cacheKey = getKey(key);
        Element element = ehcacheCache.get(key);
        if (element != null) {
